...
namespace VirusX
{
    ...
    public class MyConsole
    {
        ...
        public static void SaveException2(Exception e)
        {


            const string UnhandledExceptionsPath = "Issue\\";
        ...
        public static void SaveException3(Exception e)
        {


            const string UnhandledExceptionsPath = "Issue2\\";
