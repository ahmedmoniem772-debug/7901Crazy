...
namespace VirusX.Game.MsgServer
{
    ...
    {
        public static unsafe ServerSockets.Packet InnerPowerStageInfo(
  this ServerSockets.Packet stream,
  InnerPowerStage.ActionID action,
  uint UID,
  Role.Instance.InnerPower.Stage stage)
        {
            stream.InitWriter();

            stream.Write(UID);
            stream.Write(stage.Score);
            stream.Write(0);
            ...
            stream.Finalize(GamePackets.MsgInnerStrengthInfo);
