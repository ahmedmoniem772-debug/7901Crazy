...
namespace VirusX.Game.MsgServer
{
    public static unsafe partial class MsgBuilder
    {
        ...
        {
            stream.Finalize(GamePackets.MsgQualifyingFightersList);
            return stream;
        }
    ...
    {
        [PacketAttribute(GamePackets.MsgQualifyingFightersList)]
