                        ...
                        if (item == 0 && user.Inventory.Remove(3005360, 1, stream))
                        {
                            switch (Mode)
                            {
                                case MsgChiInfo.ChiPowerType.Dragon:
                                    {
                                        user.Player.MyChi.DragonPowers = VirusX.Role.Instance.Chi.ChiAttribute.ShallowCopy(user.Player.MyChi.Dragon.Attributes);
                                ...
                                case MsgChiInfo.ChiPowerType.Phoenix:
                                    {
                                        user.Player.MyChi.PhoenixPowers = VirusX.Role.Instance.Chi.ChiAttribute.ShallowCopy(user.Player.MyChi.Phoenix.Attributes);
                                ...
                                case MsgChiInfo.ChiPowerType.Tiger:
                                    {
                                        user.Player.MyChi.TigerPowers = VirusX.Role.Instance.Chi.ChiAttribute.ShallowCopy(user.Player.MyChi.Tiger.Attributes);
                                ...
                                case MsgChiInfo.ChiPowerType.Turtle:
                                    {
                                        user.Player.MyChi.TurtlePowers = VirusX.Role.Instance.Chi.ChiAttribute.ShallowCopy(user.Player.MyChi.Turtle.Attributes);
                            ...
                            case MsgChiInfo.ChiPowerType.Dragon:
                                {
                                    if (DateTime.Now > DateTime.FromBinary(user.Player.MyChi.DragonTime) && user.Player.MyChi.DragonTime != 1)
                                        break;
                                    user.Player.MyChi.Dragon.Attributes = VirusX.Role.Instance.Chi.ChiAttribute.ShallowCopy(user.Player.MyChi.DragonPowers);
                            ...
                            case MsgChiInfo.ChiPowerType.Phoenix:
                                {
                                    if (DateTime.Now > DateTime.FromBinary(user.Player.MyChi.PhoenixTime) && user.Player.MyChi.PhoenixTime != 1)
                                        break;
                                    user.Player.MyChi.Phoenix.Attributes = VirusX.Role.Instance.Chi.ChiAttribute.ShallowCopy(user.Player.MyChi.PhoenixPowers);
                                    Role.Instance.Chi.ComputeStatus(user.Player.MyChi);
                            ...
                            case MsgChiInfo.ChiPowerType.Tiger:
                                {
                                    if (DateTime.Now > DateTime.FromBinary(user.Player.MyChi.TigerTime) && user.Player.MyChi.TigerTime != 1)
                                        break;
                                    user.Player.MyChi.Tiger.Attributes = VirusX.Role.Instance.Chi.ChiAttribute.ShallowCopy(user.Player.MyChi.TigerPowers);
                                    Role.Instance.Chi.ComputeStatus(user.Player.MyChi);
                            ...
                            case MsgChiInfo.ChiPowerType.Turtle:
                                {
                                    if (DateTime.Now > DateTime.FromBinary(user.Player.MyChi.TurtleTime) && user.Player.MyChi.TurtleTime != 1)
                                        break;
                                    user.Player.MyChi.Turtle.Attributes = VirusX.Role.Instance.Chi.ChiAttribute.ShallowCopy(user.Player.MyChi.TurtlePowers);
                                    Role.Instance.Chi.ComputeStatus(user.Player.MyChi);
