...
namespace VirusX.Database
{
    public class YuanshenRank
    {
        ...
        public class Entry
        {
            ...
            public static implicit operator Game.MsgServer.MsgRankMemberShow.MsgRankMemberShowProto.Entry(YuanshenRank.Entry BestOf)
            {
        ...
        public class Rank
        {
            public YuanshenRank.Type _Type;
            public int MaxItems;
            public Dictionary<uint, YuanshenRank.Entry> RankingList;
            ...
            public void UpdateItem(YuanshenRank.Entry item)
            {
                lock (SynRoot)
                {
        ...
        {
            YuanshenRank.Create();
            using (Read read = new Read("EonSpiritRank.txt"))
            {
                if (!read.Reader())
                    return;
                ...
                for (int index = 0; index < count; ++index)
                {
                    ...
                    entry.Type = (YuanshenRank.Type)readLine.Read((byte)0);
                    ...
                    YuanshenRank.Ranks[entry.Type].UpdateItem(entry);
                }
            }
        }
        ...
        {
            using (Write write = new Write("EonSpiritRank.txt"))
            {
