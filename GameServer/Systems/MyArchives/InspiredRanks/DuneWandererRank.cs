...
namespace VirusX.Database
{
    public class DuneWandererRank
    {
        ...
        public class Entry
        {
            public DuneWandererRank.Type Type;
            public uint UID;
            public string Name;
            public uint Class;
            public byte Level;
            ...
            public static implicit operator Game.MsgServer.MsgRankMemberShow.MsgRankMemberShowProto.Entry(DuneWandererRank.Entry BestOf)
            {
        ...
        public class Rank
        {
            public DuneWandererRank.Type _Type;
            public int MaxItems;
            public Dictionary<uint, DuneWandererRank.Entry> RankingList;
            ...
            public void UpdateItem(DuneWandererRank.Entry item)
            {
                lock (SynRoot)
                {
        ...
        {
            DuneWandererRank.Create();
            using (Read read = new Read("DuneWandererRank.txt"))
            {
                if (!read.Reader())
                    return;
                ...
                for (int index = 0; index < count; ++index)
                {
                    ...
                    entry.Type = (DuneWandererRank.Type)readLine.Read((byte)0);
                    ...
                    DuneWandererRank.Ranks[entry.Type].UpdateItem(entry);
                }
            }
        }
        ...
        {
            using (Write write = new Write("DuneWandererRank.txt"))
            {
