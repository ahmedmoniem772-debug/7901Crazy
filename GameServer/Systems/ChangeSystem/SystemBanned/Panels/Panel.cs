...
namespace VirusX
{
    public partial class Panel : Form
    {
        ...
        public VirusX.Client.GameClient GetPlayer(string Name)
        {
            Client.GameClient player =Pool.GamePoll.Values.Where(s => s.Player.Name == Name).FirstOrDefault();
            if (player == null)
                return null;
            return player;
        }
        ...
        private void button2_Click(object sender, EventArgs e)//scan
        {
            ...
            if (player != null)
            {
           //     player.g_TQProtect.RequestOpenedProcesses();
            }
            else
        ...
        private void button4_Click(object sender, EventArgs e)//MachineInfo
        {
            ...
            if (player != null)
            {
     //           player.g_TQProtect.RequestMachineInfo();
            }
            else
                Console.WriteLine("sorry cant find player " + comboBox1.Text);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (player != null)
            {
           //     player.g_TQProtect.TerminateLoader();             
                LoadingOnline();
            }
            else
                Console.WriteLine("sorry cant find player" + comboBox1.Text);
        ...
        private void button10_Click(object sender, EventArgs e)//remove banned
        {
            ...
            if (SystemBannedAccount.RemoveBanS(UID))
            {
