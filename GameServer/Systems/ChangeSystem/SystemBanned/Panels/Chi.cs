    ...
    public partial class Chi : Form
    {
        ...
        private void Star_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (c != null)
            {
                ...
                Dont = true;
                textBox1.Text = Power.Attributes[0].Type.ToString();
                textBox2.Text = Power.Attributes[1].Type.ToString();
                textBox3.Text = Power.Attributes[2].Type.ToString();
                textBox4.Text = Power.Attributes[3].Type.ToString();
                Dont = false;
