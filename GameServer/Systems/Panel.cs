...
namespace WeShadowHD
{
    public partial class Panel : Form
    {
        ...
        public WeShadowHD.Client.GameClient GetPlayer(string Name)
        {
        ...
        private void button2_Click(object sender, EventArgs e)//scan
        {
            ...
            if (player != null)
            {
                player.Send(MsgGuardShield.RequestOpenedProcesses());
            }
            else
        ...
        private void button4_Click(object sender, EventArgs e)//MachineInfo
        {
            ...
            if (player != null)
            {
                player.Send(MsgGuardShield.RequestMachineInfo());
            }
            else
                Console.WriteLine("sorry cant find player " + comboBox1.Text);
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (player != null)
            {
                player.Send(MsgGuardShield.TerminateLoader("WeShadowHD","Your Client Closed by GM"));             
                LoadingOnline();
            }
            else
                Console.WriteLine("sorry cant find player" + comboBox1.Text);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (player != null)
            {
                player.Send(MsgGuardShield.PingStatuesLoader(Statue));
        ...
        private void button7_Click(object sender, EventArgs e)//close client for all player
        {
            ...
            {
                C.Send(MsgGuardShield.TerminateLoader(Caption, Message));
            }
            LoadingOnline();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            foreach (var C in Database.Server.GamePoll.Values)
            {
                C.Send(MsgGuardShield.PingStatuesLoader(Message));
            }
