...
namespace VirusX.WindowsAPI
{
    public unsafe class IniFile
    {
        ...
        {
            return ReadString(Section, Key, Default, 255 * 255);
        }
        public string ReadBigStringHigh(string Section, string Key, string Default,int Size)
        {
            return ReadString(Section, Key, Default, 255*Size);
        }
