...
namespace VirusX.Game.MsgTournaments
{
    public class MsgClanTwin
    {
        ...
        public static ushort MapID = 12020;
        ...
        public void Load()
        {
            Furnitures.Add(Role.SobNpc.StaticMesh.Pole, Pool.ServerMaps[MapID].View.GetMapObject<Role.SobNpc>(Role.MapObjectType.SobNpc, 15051));
        }

        public void CheckUP()
        {
            DateTime Now = DateTime.Now;
            if (Proces == ProcesType.Dead && Now.Hour == 21 && Now.Minute >= 5 && Now.Minute <= 14)
                this.Start();

            if (Proces == ProcesType.Alive)
            {
               
                if (Now.Hour == 21 && Now.Minute == 15 && Now.Second <= 2)
                    this.End();
            }
        }
        ...
        public void Start()
        {
            ...
            Furnitures[Role.SobNpc.StaticMesh.Pole].Name = "ClanTwin";
        }
