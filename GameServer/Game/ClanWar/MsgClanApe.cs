...
namespace VirusX.Game.MsgTournaments
{
    public class MsgClanApe
    {
        ...
        public static ushort MapID = 12023;
        ...
        public void Load()
        {
            Furnitures.Add(Role.SobNpc.StaticMesh.Pole, Pool.ServerMaps[MapID].View.GetMapObject<Role.SobNpc>(Role.MapObjectType.SobNpc, 15031));
        }

        public void CheckUP()
        {
            DateTime Now = DateTime.Now;
            if (Proces == ProcesType.Dead && Now.Hour == 21 && Now.Minute >= 27 && Now.Minute <= 36)
                this.Start();

            if (Proces == ProcesType.Alive)
            {
                if (Now.Hour == 21 && Now.Minute == 37 && Now.Second <= 2)
                    this.End();
            }
        }
        ...
        public void Start()
        {
            ...
            Furnitures[Role.SobNpc.StaticMesh.Pole].Name = "ClanApe";
        }
