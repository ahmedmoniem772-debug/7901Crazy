...
namespace VirusX.Game.MsgTournaments
{
    public class MsgClanDesert
    {
        ...
        public static ushort MapID = 12024;
        ...
        public void Load()
        {
            Furnitures.Add(Role.SobNpc.StaticMesh.Pole, Pool.ServerMaps[MapID].View.GetMapObject<Role.SobNpc>(Role.MapObjectType.SobNpc, 15021));
        }

        public void CheckUP()
        {
            DateTime Now = DateTime.Now;
            if (Proces == ProcesType.Dead && Now.Hour == 21 && Now.Minute >= 38 && Now.Minute <= 47)
                this.Start();
