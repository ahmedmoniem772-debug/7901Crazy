    ...
    public class ArrowBlades
    {
        public unsafe static void Execute(Client.GameClient user, InteractQuery Attack, ServerSockets.Packet stream, Dictionary<ushort, Database.MagicType.Magic> DBSpells)
        {
            ...
            if (CheckAttack.CanUseSpell.Verified(Attack, user, DBSpells, out ClientSpell, out DBSpell))
            {
                ...
                {
                    case (ushort)Role.Flags.SpellID.ArrowBlades:
                        {
                           ...
                           , ClientSpell.Level, ClientSpell.UseSpellSoul);
                            ...
                            user.Player.AddSpellFlag(Game.MsgServer.MsgUpdate.Flags.AttackArrowBlades, 10, true);
                            user.Player.SendUpdate(stream, Game.MsgServer.MsgUpdate.Flags.AttackArrowBlades, 0, (uint)DBSpell.Damage2, 0, MsgUpdate.DataType.ArrowBlades);
                            break;
                        }
                }
            }
